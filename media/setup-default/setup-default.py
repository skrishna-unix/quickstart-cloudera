...
def get_configuration_property_values(config, configuration_properties):
    ...
    for configuration_property in configuration_properties:
        ...
        set_configuration_property_value(values_by_config_key, config_key, config_value)

    return values_by_config_key


def set_configuration_property_value(values_by_config_key, config_key, config_value):
    """
